...
public class IniciBotonsController extends Application {
	...
	public IniciBotonsController () {
		...
		try{
			...
			EntityManagerFactory emf = Persistence.createEntityManagerFactory("BotigaFX_JPA"); 
	...
	private void loadScene(String controlador,FXMLLoader loader,Stage stage) {
		...
		case "persons":
			...
			personasController.setConexionBD(em);
		...
		case "products":
			...
			productsController.setConexionBD(em);
		...
		case "customers":
			...
			customersController.setConexionBD(em);
		...
		case "suppliers":
			...
			suppliersController.setConexionBD(em);
		...
		case "presences":
			...
			presencesController.setConexionBD(em);
